    ...
    <div style={{ position: "fixed", inset: 0, background: pageBg, zIndex: 0 }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span style={{ color: "#10B981", fontWeight: 600 }}>EvoStock</span>
        </div>
      ...
      {/* EvoStock iframe — passes current theme so it can style accordingly */}
      <iframe
        src={`/EvoPOS/index.html?theme=${resolvedTheme ?? "light"}`}
        title="EvoStock — Inventory & Stock Management System"
        style={{
          position: "absolute",
          top: BAR_H,
          left: 0,
