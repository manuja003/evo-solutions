...
4. [Order Creation — Store Order](#4-order-creation--stue-order)
...
│             ▼                                                               │
│  ┌──────────────────────────────────────────────────────────────────────┐  │
│  │              Server Creates Order  (Store Order Module)               │  │
...
| **Server / Waiter** | Store (Server) | Order creation only — no kitchen or bar access |
...
- Create new orders for tables via the Store Order module
...
## 4. Order Creation — Store Order

**Access:** Menu → Order | **Intended Users:** Server / Waiter, Administrator

The Store Order module is the entry point of the order lifecycle. Once an order is submitted, it immediately flows to the kitchen and/or bar for preparation.
...
> **Screenshot Placeholder — Store Order Module**
...
| Item not appearing anywhere | Order submission may have failed | Re-submit from Store Order module |
